function [Obj,it,avgw]=SSDC_AdaGrad(last, X_p, X_u, pi_p, lss, regs, eta0, T0, gamm, G,  w0, K, lambda, theta,...
...
for k=1:K
    ...
    while 1  
        ...
        c_d_grad = c_d_grad + d_grad; %1/t(g_1+...+g_t)
